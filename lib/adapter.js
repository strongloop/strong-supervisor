...
var amapi; // = appmetrics.monitor() XXX(sam) so maybe call this 'monitor'?
...
// XXX(sam) if these exports are not at the bottom, then the code doesn't find the config method
exports.use = use;
