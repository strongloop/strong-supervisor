...
var sendStatusWd = require('./status-wd');
var sendExpressRecords = require('./express-records');
var sendTraceObject = require('./trace-object').sendTraceObject;
...
if (cluster.isWorker) {
  module.exports = {
    ...
    enableTracing: process.env.supervisor_trace !== 'false',
    sendExpressRecords: sendExpressRecords,
    sendStatusWd: sendStatusWd,
...
process.env.supervisor_trace = options.enableTracing;
config.enableTracing = options.enableTracing;
...
config.start = function start() {
  ...
  this.sendStatusWd(runctl.parentCtl);
