...
exports.HELP = [
  ...
  '',
  'Run an app, allowing it to be supervised and monitored using',
  'strong-cluster-control and strong-agent/StrongOps. For more',
  'information, see XXX(URL)',
  '',
  '`app` can be a node file to run, or a package directory, the default',
  'value is ".", the current working diretory. Packages will be run by',
