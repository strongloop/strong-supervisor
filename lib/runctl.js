...
var appmetricsVersion = require('appmetrics/package.json').version;
...
if (cluster.isMaster) {
  exports.notifyStarted = function() {
    ...
    ctlChannel.notify({
      ...
      appName: getAppName(),
      agentVersion: appmetricsVersion,
...
function clusterStatus() {
  ...
  mStatus.appName = getAppName();
  mStatus.agentVersion = appmetricsVersion;
